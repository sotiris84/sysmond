...
<table>
  <tr>
    <td align="center">UNSAFE MD5SUMS DATABASE</td>
  </tr>
  <tr>
    <td>
...
//select the unsafe md5sums table				
$result = mysql_query("SELECT * FROM $tbl_name3");	
if (!$result)
    { 
...
//display the contents of the unsafe table				
