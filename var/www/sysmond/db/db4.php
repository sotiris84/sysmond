...
<table>
  <tr>
    <td align="center">UNSAFE SERVICES DATABASE</td>
  </tr>
  <tr>
    <td>
...
//select the unsafe services table				
$result = mysql_query("SELECT * FROM $tbl_name5");	
if (!$result)
    { 
...
//display the contents of the unsafe services table				
