<?php/*
 * net_synrec_temp.php - sysmond web interface
 *
...
<html>
<head>
<title>number of SYN_RECV-real time</title>
...
<table>
  <tr>
    <td align="center">REAL TIME NUMBER OF SYN-RECV OCCURING DATABASE</td>
  </tr>
  <tr>
    <td>
    <br>
    <br>
      ...
      <tr>
        ...
        <td><font face=arial size=3/><b>Number Of SYN-RECV</b></font></td>
      </tr>
<?php
...
$result = mysql_query("SELECT * FROM $tbl_name13");	
if (!$result)
    { 
...
echo "The lower the number, the better!<P>";
