<?php/*
 * lsof_temp.php - sysmond web interface
 *
...
xmlhttp.open("GET","../scripts/get_lsof_state.php?q="+str,true);
xmlhttp.send();
}
</script>
...
<table>
  <tr>
    <td align="center">REAL TIME LSOF DATABASE</td>
  </tr>
  <tr>
    <td>
    <br>
    <br>
      ...
      <tr>
        ...
        <td><font face=arial size=3/><b>Command</b></font></td>
        <td><font face=arial size=3/><b>Pid</b></font></td>
	<td><font face=arial size=3/><b>User</b></font></td>
        <td><font face=arial size=3/><b>Fd</b></font></td>
        <td><font face=arial size=3/><b>Type</b></font></td>
	 <td><font face=arial size=3/><b>Device</b></font></td>
        <td><font face=arial size=3/><b>Size/Off</b></font></td>
	<td><font face=arial size=3/><b>Node</b></font></td>
...
$result = mysql_query("SELECT * FROM $tbl_name9");	
if (!$result)
    { 
...
while($data = mysql_fetch_row($result))
     {
         echo("<tr><td><font face=arial size=3/>$data[0]</font></td><td><font face=arial size=3/>$data[1]</font></td><td><font face=arial size=3/>$data[2]</font></td><td><font face=arial size=3/>$data[3]</font></td><td><font face=arial size=3/>$data[4]</font></td><td><font face=arial size=3/>$data[5]</font></td><td><font face=arial size=3/>$data[6]</font></td><td><font face=arial size=3/>$data[7]</font></td><td><font face=arial size=3/>$data[8]</font></td><td><font face=arial size=3/>$data[9]</font></td><td><font face=arial size=3/>$data[10]</font></td></tr>");
     }
