<?php/*
 * ss_temp.php - sysmond web interface
 *
...
xmlhttp.open("GET","../scripts/get_ss_state.php?q="+str,true);
xmlhttp.send();
}
</script>
...
<table>
  <tr>
    <td align="center">REAL TIME SS DATABASE</td>
  </tr>
  <tr>
    <td>
    <br>
...
$result = mysql_query("SELECT * FROM $tbl_name10");	
if (!$result)
    { 
