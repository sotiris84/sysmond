<?php/*
 * ss_http_temp.php - sysmond web interface
 *
...
<html>
<head>
<title>http connections-real time</title>
<script>
...
xmlhttp.open("GET","../scripts/get_http_state.php?q="+str,true);
xmlhttp.send();
}
</script>
...
<table>
  <tr>
    <td align="center">REAL TIME HTTP CONNECTIONS DATABASE</td>
  </tr>
  <tr>
    <td>
    <br>
    <br>
      ...
      <tr>
        ...
        <td><font face=arial size=3/><b>Recv-Q</b></font></td>
	<td><font face=arial size=3/><b>Send-Q</b></font></td>
        <td><font face=arial size=3/><b>Local Address:Port</b></font></td>
        <td><font face=arial size=3/><b>Peer Address:Port</b></font></td>
      </tr>
<?php
...
$result = mysql_query("SELECT * FROM $tbl_name12");	
if (!$result)
    { 
...
while($data = mysql_fetch_row($result))
     {
         echo("<tr><td><font face=arial size=3/>$data[0]</font></td><td><font face=arial size=3/>$data[1]</font></td><td><font face=arial size=3/>$data[2]</font></td><td><font face=arial size=3/>$data[3]</font></td><td><font face=arial size=3/>$data[4]</font></td><td><font face=arial size=3/>$data[5]</font></td></tr>");
     }
...
<option value="SYN-RECV">SYN-RECV</option>
<option value="FIN-WAIT-1">FIN-WAIT-1</option>
<option value="FIN-WAIT-2">FIN-WAIT-2</option>
<option value="TIME-WAIT">TIME-WAIT</option>
<option value="CLOSED">CLOSED</option>
<option value="CLOSE-WAIT">CLOSE-WAIT</option>
<option value="LAST-ACK">LAST-ACK</option>
