<?php/*
 * ss_ports_temp.php - sysmond web interface
 *
...
<html>
<head>
<title>open ports-real time</title>
...
<table>
  <tr>
    <td align="center">REAL TIME OPEN PORTS DATABASE</td>
  </tr>
  <tr>
    <td>
    <br>
...
$result = mysql_query("SELECT * FROM $tbl_name11");	
if (!$result)
    { 
