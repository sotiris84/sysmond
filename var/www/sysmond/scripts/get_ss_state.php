<?php/*
 * get_ss_state.php - sysmond web interface
 *
...
$sql="SELECT * FROM ss_temp WHERE state = '".$q."'";
...
<th>recvQ</th>
<th>sendQ</th>
<th>local_address:port</th>
<th>peer_address:port</th>
</tr>";
...
while($row = mysql_fetch_array($result))
  ...
  echo "<td>" . $row['recvQ'] . "</td>";
  echo "<td>" . $row['sendQ'] . "</td>";
  echo "<td>" . $row['local_address_port'] . "</td>";
  echo "<td>" . $row['peer_address_port'] . "</td>";
  echo "</tr>";
  }
echo "</table>";
